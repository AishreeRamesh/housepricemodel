...
![output](./static/img/op1.jpg)

![output](./static/img/op2.jpg)

## Validation Report:

![output](./static/img/va1.jpg)

![output](./static/img/va2.jpg)

## RESULT:

Thus a website is designed to train the house price model and to predict the price and is hosted in the URL http://aishree.student.saveetha.in:8000/HouseModelTraining/ and http://aishree.student.saveetha.in:8000/HouseModelPrediction/ HTML code is validated.